...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2023 at 04:02 AM
...
(1, 'koneksi.png', 'aaaa', 'affas', 'aktif');
...
('1', 'Muhammad Alif Ramadhan', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'admin');
...
--
ALTER TABLE `hero`
  MODIFY `idHero` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
